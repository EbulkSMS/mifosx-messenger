...
* https://github.com/EbulkSMS/mifosx-messenger
...
Currently implements EbulkSMS API transactional messages, but is extensible to
...
Configure your MifosX and EbulkSMS settings in config.yml
